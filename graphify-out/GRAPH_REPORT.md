# Graph Report - babel-experiments  (2026-08-12)

## Corpus Check
- 118 files · ~2,304,753 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 641 nodes · 882 edges · 104 communities (72 shown, 32 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c659c997`
...
Cohesion: 0.14
Nodes (10): ClusterRanker, main(), parse_path(), Path, Exact ranker for fixed-length pages over the project's 256-symbol alphabet., Count raw-symbol suffixes, aggregating symbols by destination cluster., Exact energy-ordered enumerator for fixed-length cluster paths., Quantize surprise relative to each source state's most likely edge. (+2 more)

### Community 1 - "Community 1"
Cohesion: 0.14
Nodes (20): api_exact_neighbor(), api_generate(), api_rank(), api_russian_walk(), api_score(), api_search(), api_unrank(), cls() (+12 more)
